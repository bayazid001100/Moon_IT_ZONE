        ...
        <div className="widget widget-text">
          ...
          <div className="ttm-author-widget">
            ...
            <p className="author-widget_text">
              ...
              It has roots in a piece orem Ipsum is not simply random text. It
              has roots in a piece of loream classical.
            </p>
          </div>
        </div>
            ...
            <div className="featured-content featured-content-banner">
              ...
              <ul>
                ...
                <li>
                  ...
                  <a href="mailto:sales@moonitbd.com">sales@moonitbd.com</a>
                </li>
              </ul>
            </div>
          </div>
