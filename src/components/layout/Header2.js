              ...
              <div className="col-lg-5">
                <ul className="top-contact text-left">
                  <li>
                    ...
                    &nbsp;&nbsp;58 Raj Dream(3rd Floor), Vasane Road,
                    Shantinagar,Dhaka-1217
                  </li>
                  <li>
                    <i className="far fa-envelope" />
                    &nbsp;&nbsp;
                    <a to="mailto:sales@moonitbd.com">sales@moonitbd.com</a>
                  </li>
                </ul>
              </div>
              <div className="col-lg-7">
                <div className="topbar-right text-right d-flex justify-content-end">
                  ...
                  <div className="header-btn">
                    <a className="ttm-btn ttm-btn-size-md ttm-bgcolor-skincolor">
                      Get A Quote
                    </a>
                  </div>
                </div>
                  ...
                  <div className="col-12 site-navigation">
                    <div className="ttm-right-header">
                      <ul className="ttm-header-icons position-relative">
                        ...
                        <li className="ttm-header-cart-link ttm-bgcolor-darkgrey ttm-textcolor-white">
                          <a>
                      ...
                      <div className="ttm-custombutton ttm-bgcolor-skincolor">
                        <span className="ttm-textcolor-white">
                          {" "}
                          Emergency Help Line : +123 456 7890 123-78
                        </span>
                      </div>
                    </div>
                    <Menu />
