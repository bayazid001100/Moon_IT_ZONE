    ...
    return (
      <footer className="footer widget-footer clearfix">
              ...
              <div className="col-lg-4 col-md-4 col-sm-12 order-md-2">
                <div className="footer-logo text-sm-center">
                  {/* <img
                    ...
                    className="img-fluid"
                    alt="footer-logo"
                    src="https://i.imgur.com/8YMoBIm.png"
                  /> */}
                </div>
              </div>
                ...
                <div className="text-left">
                  ...
                  <div className="featured-icon-box left-icon icon-align-top">
                    <div className="featured-icon">
                      {/*  featured-icon */}
                      <div className="ttm-icon ttm-textcolor-white ttm-icon_elemenPt-size-md">
                    ...
                    <div className="featured-content">
                      ...
                      <div className="featured-desc">
                        <p>
                          58 Raj Dream(3rd Floor), Vasane Road, Shantinagar,
                          Dhaka-1217
                        </p>
                      </div>
                    </div>
              ...
              <div className="col-lg-4 col-md-4 col-sm-6 order-md-3 res-767-mt-20">
                <div className="text-sm-right">
                  <a className="ttm-btn ttm-btn-size-md ttm-btn-style-border ttm-btn-color-white">
                    <i className="far fa-envelope" /> sales@moonitbd.com
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className="second-footer ttm-textcolor-white bg-img2">
          <div className="container-xl">
            <div className="row">
              <div className="col-xs-12 col-sm-12 col-md-6 col-lg-5 widget-area">
              ...
              <div className="col-xs-12 col-sm-12 col-md-6 col-lg-4 widget-area">
                <div className="widget link-widget clearfix">
                  ...
                  <ul id="menu-footer-services">
                    ...
                    <li>
                      <a href={process.env.PUBLIC_URL + "/training_list1"}>
                        Training
                      </a>
                    </li>
                    <li>
            ...
            <div className="row copyright align-items-center res-767-text-center">
              <div className="col-md-6">
                <div>
                  <span>
                    Copyright © 2021 &nbsp;
                    <a href={process.env.PUBLIC_URL + "/"}>MOON IT ZONE</a>
                  </span>
                </div>
              </div>
              <div className="col-md-6">
