                  ...
                  <div className="section-title with-desc clearfix">
                    ...
                    <div className="title-desc">
                      <p>
                        ...
                        customers and ongoing relationships are what we strive
                        for. Success is measured by results, the most important
                        being how our clients feel about their experience with
                        us.
                      </p>
                    </div>
                  </div>
              ...
              <div className="col-lg-6 offset-lg-3">
                ...
                <div className="section-title with-desc text-center clearfix">
                  <div className="title-header">
                    <h5>Our Services</h5>
                    <h2 className="title">
                      We run all kinds of IT services with 20 years of{" "}
                      <span className="ttm-textcolor-white">experience</span>
                    </h2>
                  </div>
                </div>
                {/* section title end */}
                ...
                <div className="featured-icon-box style5 text-left res-767-mb-20">
                  ...
                  <div className="featured-content">
                    ...
                    <div className="featured-desc">
                      ...
                      <p>
                        UX team create web solutions that are both intuitively
                        tailored to match our clients’ specific tasks.
                      </p>
                    </div>
                    <a className="ttm-btn ttm-btn-size-sm btn-inline mt-3">
                ...
                <div className="featured-icon-box style5 text-left res-767-mb-20">
                  ...
                  <div className="featured-content">
                    ...
                    <div className="featured-desc">
                      {/* featured-description */}
                      <p>
                        Digital solutions have transformed the world’s customer
                        expectations and the profitable growths.
                      </p>
                    </div>
                    <a className="ttm-btn ttm-btn-size-sm btn-inline mt-3">
                      Read More <i className="ti ti-angle-double-right" />
              ...
              <div className="col-lg-4 col-md-4">
                ...
                <div className="featured-icon-box style5 text-left">
                  ...
                  <div className="featured-content">
                    {/* featured-content */}
                    <div className="featured-title">
                      <h5>Content Engineering</h5>
                      {/* featured-title */}
                    </div>
                    <div className="featured-desc">
                      {/* featured-description */}
                      <p>
                        We are here in the fields of organizing bridging the
                        gaps between strategy and the development.
                      </p>
                    </div>
                    <a className="ttm-btn ttm-btn-size-sm btn-inline mt-3">
                      Read More <i className="ti ti-angle-double-right" />
          ...
          <div className="container-xl">
            <div className="row no-gutters">
              <div className="col-lg-3">
                ...
                <img
                  src="https://via.placeholder.com/1200X628/444444.jpg"
              ...
              <div className="col-md-12">
                ...
                <div className="section-title text-center with-desc clearfix">
                  <div className="title-header">
                    ...
                    <h2 className="title">
                      Here are some <span>Milestones </span>
                    </h2>
                  </div>
                </div>
                {/* section title end */}
                ...
                <div className="ttm-tabs text-center ttm-tab-style-classic style1">
                  ...
                  >
                    ...
                    <TabList className="tabs">
                      <Tab className="tab" title="Hi-Tech">
                        <span>
                          <i className="flaticon flaticon-report" /> Hi-Tech
                        </span>
                      </Tab>
                      <Tab className="tab" title="Media">
                        <span>
                          <i className="flaticon flaticon-computer" /> Media
                        </span>
                      </Tab>
                      <Tab className="tab" title="Industrial">
                        <span>
                          <i className="flaticon flaticon-system" /> Industrial
                        </span>
                      </Tab>
                      ...
                      <Tab className="tab" title="Medical">
                        <span>
                          <i className="flaticon flaticon-analysis" /> Medical
                        </span>
                      </Tab>
                    </TabList>
                            ...
                            <div className="row">
                              <div className="col-lg-6">
                                <div className="text-left">
                                  ...
                                  <p>
                                    High-tech industries play an important role
                                    in the modern economy, and often experience
                                    significantly higher pay than other
                                    industries. And Digital solutions have
                                    transformed the world’s.
                                  </p>
                                  <p>
                                    Sometimes you get into it for the wrong
                                    reasons, &amp; eventually it hits you on the
                                    face. These reasons can be drawbak but an
                                    eye opener too. These reasons can be drawbak
                                  ...
                                  <ul className="ttm-list ttm-list-textsize-medium ttm-list-style-icon pt-15">
                                    ...
                                    <li>
                                      <i className="fa fa-arrow-circle-right ttm-textcolor-skincolor" />
                                      <span className="ttm-list-li-content">
                                        Practice maturity in hardware, firmware
                                        and middleware
                                      </span>
                                    </li>
                                    <li>
                                ...
                                <div className="grey-border res-991-mt-30 text-left">
                                  ...
                                  <div className="ttm_single_image-wrapper with-border15">
                                    <img
                                      ...
                                      src="https://via.placeholder.com/495X432/444444.jpg"
              ...
              <div className="col-lg-6">
                <div className="position-relative res-991-mt-30">
                  ...
                  <div className="ttm_single_image-wrapper text-right">
                    <img
                      className="img-fluid"
                      src="https://via.placeholder.com/434X668/444444.jpg"
