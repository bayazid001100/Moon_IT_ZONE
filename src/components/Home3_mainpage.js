                ...
                <div className="featured-icon-box style6">
                  <div className="featured-content">
                    ...
                    <div className="featured-desc">
                      {/*  featured-desc */}
                      <p>
                        Our firm is an expert to creates an efficient user
                        interface that make user interaction.
                      </p>
                    </div>
                  </div>
                ...
                <div className="featured-icon-box style6">
                  <div className="featured-content">
                    ...
                    <div className="featured-desc">
                      {/*  featured-desc */}
                      <p>
                        We provide an IT management services is for according to
                    ...
                    <div className="row">
                      <div className="col-lg-6">
                        ...
                        <div className="ttm_single_image-wrapper">
                          <img
                            className="img-fluid"
                            src="https://via.placeholder.com/547X582/444444.jpg"
              ...
              <div className="col-md-3 col-6">
                ...
                <div className="ttm-fid inside ttm-fid-view-topicon">
                  ...
                  <div className="ttm-fid-contents">
                    ...
                    <h3 className="ttm-fid-title">Services Provider</h3>
                    {/*  ttm-fid-title */}
                  </div>
                  {/* ttm-fid-contents end */}
                </div>
                ...
                <div className="featured-imagebox featured-imagebox-team style1">
                  <div className="featured-thumbnail">
                    ...
                    <img
                      className="img-fluid"
                      alt=""
                      src="https://via.placeholder.com/480X520/444444.jpg"
                    />
                  ...
                  <div className="featured-content box-shadow">
                    ...
                    <p className="category">IT Service Officer</p>
                    {/* category */}
                  </div>
                </div>
              </div>
          ...
          <div className="container-xl">
            ...
            <div className="row">
              <div className="col-md-8 offset-md-2">
                <Slider
                  className="testimonial-slide style1 pt-0 slick_slider res-991-pb-0"
                  arrows={false}
                  dots={false}
                >
                  <div className="testimonials text-center">
                    <div className="testimonial-content">
                      ...
                      <blockquote>
                        Our team discussed every single detail to make sure
                        Creatives Planet is the most versatile and unique theme
                        created so far. No coding skills.
                      </blockquote>
                          ...
                          <div className="section-title with-desc clearfix">
                            ...
                            <div className="title-desc">
                              <p>
                                ...
                                profession, however, in a passion for our
                                Company. We have a tendency to believe the idea
                                that smart looking of any website is the first
                                impression on visitors. And the smart design.
                              </p>
                              <p>
                                We have a special team for website style who has
                                been involved in designing professional
                                websites.
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="col-lg-6 res-991-text-center">
                        <div className="res-991-mt-30">
                          ...
                          <div className="ttm_single_image-wrapper">
                            <img
                              className="img-fluid"
                              src="https://via.placeholder.com/538X512/444444.png"
                              title="single-img-six"
                              alt="single-img-six"
                            />
                          </div>
                          {/* ttm_single_image-wrapper end */}
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-xl-5">
                <div className="text-center">
                  <div className="mb-4">
                    <img
                      src="https://via.placeholder.com/112X118/444444.png"
                      alt="icon-image"
                    />
                  </div>
              ...
              <div className="col-md-12">
                ...
                <div className="section-title text-center with-desc clearfix">
                  <div className="title-header">
                    ...
                    <h2 className="title">
                      A monthly project fee <span>Price Plans</span>
                    </h2>
                  </div>
                </div>
                {/* section title end */}
            ...
            <div className="row no-gutters mt_100 res-991-mt-0">
                ...
                <div className="ttm-pricing-plan box-shadow text-left clearfix">
                  ...
                  <div className="ttm-ptablebox-content">
                    <div className="ttm-ptablebox-price-w">
                      ...
                      <div className="ttm-ptablebox-price">70.00</div>
                      {/*price*/}
                  ...
                  <div className="price_btn">
                    <a className="ttm-btn ttm-btn-size-md ttm-bgcolor-grey mb-3 w-100">
                      Get Started
                    </a>
                  </div>
                </div>
              ...
              <div className="col-md-4">
                ...
                <div className="ttm-pricing-plan ttm-pricing-plan-col box-shadow text-left clearfix">
                  <div className="ttm-featured-title">
                    <i className="fa fa-star" />
                    MOST POPULAR
                  </div>
                  <div className="ttm-ptablebox-title">
                  ...
                  <div className="ttm-ptablebox-content">
                    <div className="ttm-ptablebox-price-w">
                      <div className="ttm-ptablebox-cur-symbol-before">$</div>
                      <div className="ttm-ptablebox-price">90.00</div>
                      {/*price*/}
                      <div className="ttm-ptablebox-frequency">per month</div>
                    </div>
                    <div className="ttm-ptablebox-features">
                  ...
                  <div className="price_btn">
                    <a className="ttm-btn ttm-btn-size-md ttm-bgcolor-skincolor w-100">
                      Get Started
                    </a>
                  </div>
                </div>
              ...
              <div className="col-md-4">
                ...
                <div className="ttm-pricing-plan box-shadow text-left clearfix">
                  ...
                  <div className="ttm-ptablebox-content">
                    <div className="ttm-ptablebox-price-w">
                      <div className="ttm-ptablebox-cur-symbol-before">$</div>
                      <div className="ttm-ptablebox-price">60.00</div>
                      {/*price*/}
                      <div className="ttm-ptablebox-frequency">per month</div>
                    </div>
                    <div className="ttm-ptablebox-features">
