                    ...
                    <div className="carousel-caption-inner banner3">
                      ...
                      >
                        <p className="text">
                          ...
                          serve our customers properly. Our method of
                          application maintains the industry.
                        </p>
                        <span></span>
                      </MDBAnimation>
                      <MDBAnimation className="slideInUp" count={1} delay="3s">
                        <p>
                          <button className="mt-5 res-767-mt-0 ttm-btn ttm-btn-size-md ttm-btn-style-border ttm-btn-color-white ttm-textcolor-white">
                            view our projects
                          </button>
                        </p>
                      </MDBAnimation>
                  ...
                  <div className="container-xl">
                    <div className="carousel-caption-inner banner4">
                      ...
                      <MDBAnimation className="slideInUp" count={1} delay="6s">
                        <p className="mt-4">
                          <button className="ttm-btn ttm-btn-size-md ttm-bgcolor-skincolor mr-3">
                            read more
                          </button>
                          <button className="ttm-btn ttm-btn-size-md ttm-btn-style-border ttm-btn-color-white">
                            get Altech
                          </button>
                        </p>
                      </MDBAnimation>
