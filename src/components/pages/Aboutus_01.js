          ...
          <div className="container-xl">
            <div className="row">
              ...
              <div className="col-lg-6">
                ...
                {/* row END*/}
                <p className="mb-2">
                  High-tech industries play an important role in the modern
                  economy, and often experience significantly higher pay than
              ...
              <div className="col-lg-6">
                <div className="position-relative res-991-mt-30">
                  ...
                  <div className="ttm_single_image-wrapper text-sm-center">
                    <img
                      className="img-fluid"
                      src="https://i.imgur.com/BKbRH0m.png"
                ...
                <div className="ttm-bgcolor-grey ttm-bg ttm-col-bgcolor-yes ttm-left-span spacing-7 position-relative z-1">
                    ...
                    <div className="row">
                      <div className="col-lg-6">
                        ...
                        <div className="ttm_single_image-wrapper">
                          <img
                            className="img-fluid"
                            src="https://i.imgur.com/LTT3p9j.jpg"
                      ...
                      <div className="col-lg-6">
                        <div className="res-991-mt-30">
                          ...
                          <div className="mt-4">
                            ...
                            <div className="ttm-progress-bar">
                              <div className="progress-bar-title float-left">
                                Enterprice System &amp; Private Cloud
                              </div>
                              {/* progress-bar-title */}
                              <label className="float-right">90%</label>
                              <MDBProgress
                            ...
                            <div className="ttm-progress-bar">
                              ...
                              {/* progress-bar-title */}
                              <label className="float-right">92%</label>
                              <MDBProgress
                                className="w-100"
                                material
                                value={92}
                  ...
                  <div style={{ textAlign: "center" }}>
                    <a
                      ...
                      className="ttm-btn ttm-bgcolor-skincolor ttm-btn-size-md mt-4"
                    >
          ...
          <div className="container-xl">
            ...
            <div className="row">
              <div className="col-md-8 offset-md-2">
                <Slider
                  className="testimonial-slide style1 slick_slider pb-0"
                  arrows={false}
                  dots={false}
                >
                      ...
                      <div className="testimonial-avatar">
                        <div className="testimonial-img">
                          ...
                          <img
                            ...
                            alt="testimonial-img"
                            src="https://i.imgur.com/rlhXx84.jpg"
                          />
                        </div>
                      </div>
                      <blockquote>
