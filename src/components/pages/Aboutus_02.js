              ...
              <div className="col-lg-6">
                <div className="position-relative">
                  ...
                  <div className="ttm_single_image-wrapper text-sm-center mr-35 res-991-m-0">
                    <img
                      className="img-fluid"
                      src="https://via.placeholder.com/500X521/444444.jpg"
                  ...
                  <div className="section-title with-desc clearfix">
                    ...
                    <div className="title-desc">
                      <p>
                        ...
                        higher pay than other industries. And Digital solutions
                        have transformed the world’s web applications.
                      </p>
                    </div>
                  </div>
                  {/* section title end */}
                        ...
                        <div className="featured-content">
                          ...
                          <div className="featured-desc">
                            ...
                            <p>
                              ...
                              gain insights from large information for web
                              optimal platform to develop.
                            </p>
                          </div>
                        </div>
                      </div>
