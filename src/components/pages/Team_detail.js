          ...
          <div className="container-xl">
                        ...
                        <ul className="ttm-team-details-list clearfix">
                          <li>
                            ...
                            <div className="ttm-team-list-value">
                              <a href="tel:+1800200145">+1800200145</a>
                            </div>
                          </li>
                          <li>
                            <div className="ttm-team-list-title">
                            ...
                            <div className="ttm-team-list-value">
                              <a href="mailto:sales@moonitbd.com">
                                sales@moonitbd.com
                              </a>
                            </div>
                          </li>
                          <li>
                            ...
                            <div className="ttm-team-list-value">
                              <a
                                target="_blank"
                                href="https://www.themetechmount.com/"
                              >
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <div className="ttm-progress-bar">
                  ...
                  <MDBProgress
                    className="w-100 ttm-bgcolor-darkgrey"
                    material
                    value={77}
                  ></MDBProgress>
                </div>
            ...
            <div className="row mt-5">
              <div className="col-12">
                ...
                <p className="mb-5">
                  Prior to joining Integrio, he spent 20+ years at Inmosys,
                  ...
                  business, as well as a board member of their software
                  subsidiary. He is also an avid cook and history buff. You can
                  find him dining late at night with the chefs of the hotels
                  where he stays during his travels, or reading in his home
                  library.
                </p>
              </div>
            </div>
                        ...
                        <div className="col-sm-6 col-md-6">
                          <div className="form-group">
                            <input
                              name="name"
                              type="text"
                              className="form-control ttm-bgcolor-grey"
